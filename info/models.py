...
time_slots = (
    ...
    ('01:50 - 02:40', '01:50 - 02:40'),
    ('02:40 - 03:30', '02:40 - 03:30'),
    ('3:40 - 4:30', '3:40 - 4:30'),
...
class Student(models.Model):
    ...
    name = models.CharField(max_length=200)
    email_id = models.EmailField(max_length=30,  default="",editable=False)
    sex = models.CharField(max_length=50, choices=sex_choice, default='Male')
    DOB = models.DateField(default='2002-01-01')
...
class AssignTime(models.Model):
    ...
    period = models.CharField(max_length=50, choices=time_slots, default='9:10 - 10:00')
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                   ...
                   # sc.marks_set.create(name='Event1')
