...
urlpatterns = [
    ...
    path('send_marks_intimation/', views.send_marks_intimation, name='send_marks_intimation'),
    path('contact/', views.contact, name='contact'),
    path('send_marks_updation/', views.send_marks_updation, name='send_marks_updation'),
